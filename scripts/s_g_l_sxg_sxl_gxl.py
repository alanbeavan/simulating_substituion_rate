...
Conditions:
site + gene + lineage + site x gene + site x lineage + gene x lineage.
...
def main():
    ...
    while i < 70:
        ...
        gene_tree = variation.relaxed_tree(base_tree, rate, params.lineage_sigma2)
        j = 0
        while j < params.n_bins_per_gene:
            relaxed_trees.append(variation.relaxed_tree(gene_tree,
                                                        1,
